###########################################################
### Creates a simple email interaction graph on time axis
### Needs to be refactored to use ggplot2
### maybe also present an interaction graph via network analysis
###########################################################
